...
•	Locally: download the .py script *“OVG_v2_Over2_5Goals.py”* and run with a local Python 3 environment. To run the script locally, you need to create two folders named **"DataTreated"** and **"FullData"**. These folders will store the Excel workbooks generated by the script.
...
## Acknowledgements
This script is intended solely for demonstrative and educational purposes and has no commercial intent or affiliation.

All match data and statistics are sourced from **SoccerStats.com**, whose platform is gratefully acknowledged.
